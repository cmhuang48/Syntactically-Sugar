...
export const createCupcake = (category, name, flavor, frosting, message) => {
  return async (dispatch) => {
    const cupcake = (await axios.post('/api/cupcakes', { category, name, flavor, frosting,  message })).data
    dispatch({
      type: CREATE_CUPCAKE,
      cupcake
    })
